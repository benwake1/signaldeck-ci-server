<x-filament-panels::page>
    ...
    >
        ...
        <div class="mb-6 rounded-xl border p-4 flex items-center justify-between"
             :class="{
                'bg-green-50 border-green-200 dark:bg-green-950 dark:border-green-800': status === 'passing',
                'bg-red-50 border-red-200 dark:bg-red-950 dark:border-red-800': status === 'failed' || status === 'error',
                'bg-yellow-50 border-yellow-200 dark:bg-yellow-950 dark:border-yellow-800': ['pending','cloning','installing','running'].includes(status),
                'bg-gray-50 border-gray-200 dark:bg-gray-900 dark:border-gray-700': status === 'cancelled',
             }">
